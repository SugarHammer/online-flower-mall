  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="商品名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="商品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="鲜花分类" prop="shangpinfenlei">
          <el-select v-model="ruleForm.shangpinfenlei" placeholder="请选择鲜花分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="鲜花分类" prop="shangpinfenlei">
          ...
          <el-form-item class="input" label="价格" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="价格" readonly></el-input>
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="鲜花详情" prop="shangpinxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinxiangqing" label="鲜花详情" prop="shangpinxiangqing">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springboot7z60r/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
